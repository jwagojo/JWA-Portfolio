function Skills() {
    ...
    return (
        <div>
            ...
            <div className={`scale-90 md:scale-100 max-h-full max-w-full absolute md:flex-row flex-wrap md:top-[25%] left-1/2 -translate-x-1/2 z-[3] flex gap-3 md:gap-7 items-center`}>
                        {
