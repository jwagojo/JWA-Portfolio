...
function Experience() {
    ...
    return (
        <div>
            <div className="md:scale-120 absolute px-14 py-30 flex-col md:px-12 md:py-12 md:top-[20%] md:left-[10%] md:flex-row flex-wrap max-h-full max-w-full flex gap-4 md:gap-7">
