                ...
                </a>
                {
                    list.map((link, index) => (
                        <a
                            ...
                            className="text-sm md:text-2xl w-fit portfolio-button text-white no-underline font-['IBM_Plex_Mono',_monospace] border-2 border-white px-10 py-[15px] transition-all duration-300 whitespace-nowrap hover:bg-white hover:text-black"
                        >
                            {link.name}
                        </a>
                    ))
